...
//     version 1.14.2
//     from Assets/SkyForgeForUnity/SkyForge/Services/ConsoleService/Scripts/Input/NewInputSystem/ConsoleNewInputSystem.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/SkyForgeForUnity/SkyForge/Services/ConsoleService/Scripts/Input/NewInputSystem/ConsoleNewInputSystem.inputactions".
    /// </summary>
    /// <remarks>
    ...
    /// </code>
    /// </example>
    public partial class @ConsoleNewInputSystem: IInputActionCollection2, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public @ConsoleNewInputSystem()
        {
            asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""ConsoleNewInputSystem"",
    ""maps"": [
        {
            ""name"": ""ConsoleService"",
    ...
    ""controlSchemes"": []
        ...
        ~@ConsoleNewInputSystem()
        {
            UnityEngine.Debug.Assert(!m_ConsoleService.enabled, "This will cause a leak and performance issues, ConsoleNewInputSystem.ConsoleService.Disable() has not been called.");
        }
        ...
        /// <summary>
        /// Provides access to input actions defined in input action map "ConsoleService".
        /// </summary>
        public struct ConsoleServiceActions
        {
            private @ConsoleNewInputSystem m_Wrapper;

            /// <summary>
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public ConsoleServiceActions(@ConsoleNewInputSystem wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "ConsoleService/OpenConsole".
            /// </summary>
            ...
            /// <summary>
            /// Implicitly converts an <see ref="ConsoleServiceActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            ...
            /// </remarks>
            /// <seealso cref="ConsoleServiceActions" />
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ConsoleServiceActions.UnregisterCallbacks(IConsoleServiceActions)" />.
            /// </summary>
            /// <seealso cref="ConsoleServiceActions.UnregisterCallbacks(IConsoleServiceActions)" />
            ...
            /// </remarks>
            /// <seealso cref="ConsoleServiceActions.AddCallbacks(IConsoleServiceActions)" />
            /// <seealso cref="ConsoleServiceActions.RemoveCallbacks(IConsoleServiceActions)" />
            /// <seealso cref="ConsoleServiceActions.UnregisterCallbacks(IConsoleServiceActions)" />
        ...
        /// <summary>
        /// Provides a new <see cref="ConsoleServiceActions" /> instance referencing this action map.
        /// </summary>
        public ConsoleServiceActions @ConsoleService => new ConsoleServiceActions(this);
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "ConsoleService" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="ConsoleServiceActions.AddCallbacks(IConsoleServiceActions)" />
        /// <seealso cref="ConsoleServiceActions.RemoveCallbacks(IConsoleServiceActions)" />
